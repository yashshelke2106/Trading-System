    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      {(error || lastUpdated) && (
        <div style={{
          ...
          borderRadius: 8, color: error ? "#f59e0b" : "var(--txd)",
      ...
      <section>
        ...
        {stats.unresolved_lot > 0 && (
          <p style={{ color: "#f59e0b", fontSize: ".72em", marginTop: 8 }}>
            ...
            {sorted.map(t => {
              ...
              return (
                <tr key={t.trade_id}>
                  ...
                  <td style={{ ...TD, color: t.lot_resolved ? "var(--tx)" : "#f59e0b" }}
